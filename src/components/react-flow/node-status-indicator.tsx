  ...
  return (
    <>
      ...
      `}
        ...
        >
          <div className="spinner rounded-full bg-[conic-gradient(from_0deg_at_50%_50%,#155dfb0a_0deg,#155dfb_360deg)]" />
        </div>
      </div>
      {children}
    </>
...
const StatusBorder = ({
  ...
  return (
    <>
      <div
        className={cn(
          "absolute -top-px -left-px h-[calc(100%+2px)] w-[calc(100%+2px)] rounded-[6px] border-3",
          className
        )}
      />
      {children}
